package pl.edu.pw.ee.rbtMap;

import static pl.edu.pw.ee.rbtMap.Color.BLACK;
import static pl.edu.pw.ee.rbtMap.Color.RED;
...
public class RedBlackTree<K extends Comparable<K>, V> {
    ...
    private void returnReverseOrder(Node<K, V> node) {
        if (node != null) {
            returnReverseOrder(node.getRight());
            traversalResult = traversalResult + node.getKey() + ":" + node.getValue() + "\n";
            returnReverseOrder(node.getLeft());
        }
    }
